namespace shop.Web.Data
{
    ...
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            var user = await this.CheckUserAsync("samueldc29@gmail.com", "Samuel", "Ramirez", "Admin");
        ...
        {
            this.AddCountry("Republica Dominicana", new string[] { "Santo Domingo", "Santiago", "Puerto Plata", "Punta Cana", "Samana", "La Vega", "Higuey" });
